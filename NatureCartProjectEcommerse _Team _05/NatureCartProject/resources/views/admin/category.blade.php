        ...
        <table class="table table-bordered border-primary">
            ...
            <thead class="table-light">
                ...
                <tr>
                    ...
                    <td><img src="{{asset('img/'.$item->image)}}" alt="image" class="img-fluid p-5" height="100%" width="100%"></td>
                    <td>{{$item->product_descrip}}</td>

                    <td>
                        <!-- Edit -->
                        <a href='{{ url("admin/editcategory/$item->id") }}' class="btn btn-sm btn-info">Modify</a>
                        <!-- Delete -->
