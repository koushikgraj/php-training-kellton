...
<div class="col-md-12 col-sm-12 col-xs-12">
               ...
               <div class="x_content">
                    <br>
                    <form id="demo-form2" action="{{route('product.update',$product->id)}}" method="post" class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
                     @csrf
                     <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" id="first-name" name="price" value="{{$product->price}}" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <img style="height:80px;widht:80px:" src="{{asset('uploads/'.$product->image)}}" >
                        </div>
                      </div>
