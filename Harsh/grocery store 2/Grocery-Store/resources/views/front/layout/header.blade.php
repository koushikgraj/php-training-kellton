                ...
                <div class="col-lg-6">
                    <nav class="header__menu">
                        <ul>
                            ...
                            <li><a href="{{route('checkout')}}">Check Out</a>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="hero__categories">
                        ...
                        <ul>
                            <li><a href="#">Masala,Oil & More</a>
                            
                       <ul>
                       <li><a href="">Ghee & Oil</a></li>
                            <li><a href="">Masala & Spices</a></li>
                            <li><a href="">Salt & Sugar</a></li>
                       </ul>
                        </li>
                            <li><a href="#">Snacks And Packaged Food</a>
                            <ul>
