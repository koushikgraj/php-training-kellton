     ...
     <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="email_id" class="form-control" placeholder="Enter email_id">
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>mobilenumber:</strong>
                <input type="text" name="mobilenumber" class="form-control" placeholder="Enter number">
            </div>
        </div>
