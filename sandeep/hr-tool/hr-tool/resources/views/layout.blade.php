            ...
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                   ...
                   <div class="nav-item dropdown">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>onboarding </a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="{{url('display-ProfilePage')}}" class="dropdown-item">ProfilePage</a>
                            <a href="{{url('display-Qualification')}}" class="dropdown-item">Qualifications</a>
                            <a href="{{url('create')}}" class="dropdown-item">Bank Details</a>
                            <a href="{{url('create')}}" class="dropdown-item">Skills Required</a>
                            <a href="{{url('create')}}" class="dropdown-item">Work Experience</a>
                            <a href="{{url('create')}}" class="dropdown-item">Company Requirement</a>
