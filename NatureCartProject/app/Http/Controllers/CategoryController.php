...
class CategoryController extends Controller
{
  ...
  /**
   * Update cartlist  the specified resource in storage.
   *
   * @param  \Illuminate\Http\Request  $request
   * @param  int  $id
   * @return \Illuminate\Http\Response
  ...
  public function addproduct(Request $req)
  {
    ...
    $product->save();
    // return redirect('admin/manage_category')->with('message','Sending data successfully');
  ...
  public function updateproduct(Request $request, $id)
  {
    ...
    if ($categories) {
      ...
      // return redirect('admin/category')->with('message', 'Product Edit Successful!');
  ...
  public function checkout(Request $req)
  {
    ...
    $res->zip = $req->zip;
    $res->save();
    return redirect('thankyou')->with('message', 'Sending data successfully');
  }
