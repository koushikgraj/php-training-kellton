...
@section('container')
   <center> <h1  class="mb10">Manage Category</h1></center>
    <a href="category">
        ...
        <img src="{{asset('admin_assets/images/icon/upload.png')}}" alt="image" id="img" style="max-width:100px; display: block; margin-left: auto; margin-right: auto; padding-bottom: 10px; width: 50%;">
                           <input type="file" id="upload" name="image">
                                            ...
                                            <div class="form-group has-success">
                                                ...
                                                <input id="cc-name" name="product_descrip" type="text" class="form-control cc-name valid" data-val="true" data-val-required="Please enter the name on card"
                                                    autocomplete="cc-name" aria-required="true" aria-invalid="false" aria-describedby="cc-name-error">
                                                <span class="help-block field-validation-valid" data-valmsg-for="cc-name" data-valmsg-replace="true"></span>
                                            </div>
