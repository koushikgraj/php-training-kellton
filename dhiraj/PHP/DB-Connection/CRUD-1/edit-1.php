...
if(isset($_POST['submitbtn'])){
	...
	echo "<script>location.replace('list-1.php?action=update&status=success');</script>";
}


//read the data from database to populate text box records
$id = mysqli_real_escape_string($conn, $_GET['id']);
$sql_select = "SELECT * FROM Stud WHERE id = '$id'";
...
           <label >Female</label>
		...
		<br>
		<a href="list-1.php">Got to student list</a>
	</body>
</html> 