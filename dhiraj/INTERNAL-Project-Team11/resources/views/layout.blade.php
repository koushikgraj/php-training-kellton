...
<head>
    <meta charset="utf-8">
    <title>Team1 - Electronic Store</title>
                    ...
                    <div class="navbar-nav w-100 overflow-hidden" style="height: 410px">
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu position-absolute bg-secondary border-0 rounded-0 w-100 m-0">
                                ...
                                <a href="lenevo_laptop" class="dropdown-item">LENEVO</a>

                            </div>
                        </div>
                        <a href="mobiles" class="nav-item nav-link">Mobiles</a>
                        <a href="Charger" class="nav-item nav-link">Charger</a>
    ...
    <div class="container-fluid bg-secondary text-dark mt-5 pt-5">
        <div class="row px-xl-5 pt-5">
            <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                ...
                <p>This is an E-commerce Electronic website for online shopping of electronic items, This website is created by Team-1.</p>
                <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>123 Street,Gurgaon, INDIA</p>
                <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>team.1.project@gmail.com</p>
        ...
        <div class="row border-top border-light mx-xl-5 py-4">
            <div class="col-md-6 px-xl-0">
                <p class="mb-md-0 text-center text-md-left text-dark">
                    &copy; <a class="text-dark font-weight-semi-bold" href="#">Team-1 Site </a>. All Rights Reserved. Designed
                    by
                    <a class="text-dark font-weight-semi-bold" href="https://htmlcodex.com">Team-1 Developers</a><br>
                    Distributed By <a href="https://themewagon.com" target="_blank">Team-1</a>
                </p>
            </div>
