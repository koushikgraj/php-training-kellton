                    ...
                    <div class="content">
                      <form id="contact" action="" method="post">
                        <div class="row">
                          ...
                          <div class="col-md-6 col-sm-12">
                            <fieldset>
                              <input name="dob" type="text" id="dob" placeholder="Your date of birth" required="">
                            </fieldset>
                          </div>
                          <div class="col-md-6 col-sm-12">
                            <fieldset>
                              <input  name ="mobile_no" type="number" id="mobile_no" placeholder="Your Mobile No" required="">
                            </fieldset>
                          </div>
                          <div class="col-md-6 col-sm-12">
                            <fieldset>
                          ...
                          <div class="col-md-6 col-sm-12">
                            <fieldset>
                              <input name="county" type="text" id="country" placeholder="Your county name" required="">
                            </fieldset>
                          </div>
                          <div class="col-md-6 col-sm-12">
                            <fieldset>
                          ...
                          <div class="col-md-6 col-sm-12">
                            <fieldset>
                              <input name="remember_token" type="text" id="remember_no"  required="">
                            </fieldset>
                          </div>
