        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                <a href="index.html" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>ERP System</h3>
                </a>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="button.html" class="dropdown-item">Attendance Feel</a>
                            <a href="{{ url('holiday') }}" class="dropdown-item">Hollydays</a>
                            <a href="element.html" class="dropdown-item">Timesheet</a>
                            <a href="element.html" class="dropdown-item">Display Attendance Employee</a>
                        </div>
                    </div>
