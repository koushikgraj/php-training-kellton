     ...
     <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="Tech_Name" class="form-control" placeholder="Enter Tech_Name">
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="Education" class="form-control" placeholder="Enter ur Education">
            </div>
        </div>
