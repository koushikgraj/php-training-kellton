...
class AuthController extends Controller
{
    ...
    {
        $this->middleware('auth:api', ['except' => ['login', 'refresh', 'logout','testExeception']]);
    }
     ...
     /*  if (!$request->is('api/*')) {
       ...
       try {
            if($request->method() != 'POST'){
                Log::notice("New User is trying to access get method in AuthController::testExeception();");
