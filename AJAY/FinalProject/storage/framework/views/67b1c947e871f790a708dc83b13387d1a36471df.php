...
<body>
<form method="post" action="<?php echo e(url('adlogin')); ?>"> 
    <?php echo csrf_field(); ?>  
                    ...
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <a href="index.html" class="">
                                <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>WELCOME USER</h3>
                            </a>
                            <h3>Sign In</h3>
                        </div>
...
<?php /**PATH C:\xampp\htdocs\practice\php-training-kellton\Aditi\FinalProject\resources\views/login.blade.php ENDPATH**/ ?>