  ...
  <body>
    ...
    <div class="main-block">
      <div class="left-part">
        ...
        <h1>YOU CAN APPLY EARNED LEAVE FROM HERE</h1>
      ...
      <form action="/">
        ...
        <!-- <select>
          ...
          LEAVE-TYPE<select><option value="short-courses">Earned Leave</option></select>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\practice.php\php-training-kellton\Harsh\dffgd\FinalProject\resources\views/apply/earn.blade.php ENDPATH**/ ?>