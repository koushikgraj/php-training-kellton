  ...
  <body>
    ...
    <div class="main-block">
      <div class="left-part">
        ...
        <h1>YOU CAN APPLY MARRAIGE LEAVE FROM HERE</h1>
      ...
      <form action="/">
        ...
        <!-- <select>
          ...
          LEAVE-TYPE<select><option value="short-courses">Marraige Leave</option></select>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\practice.php\php-training-kellton\Harsh\dffgd\FinalProject\resources\views/apply/marraige.blade.php ENDPATH**/ ?>