...
<form action="{{url('admin/category/addcategory')}}" method="post">
        @csrf
            ...
            <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
                ...
                {{session('message')}}
                    ...
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>Add Medicine</h3>
                           
                        </div>
                        <div class="form-floating mb-3">
                            <input type="file" class="form-control" name="image" height="100px" width="120px">
