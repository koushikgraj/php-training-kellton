...
<!-- This code is for  OnBording  -->
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>OnBording Details</a>
                        <div class="dropdown-menu bg-transparent border-0">
                        ...
                        <a href="{{url('Qualification')}}" class="dropdown-item">Qualification</a>
                            <a href="{{url('Skills')}}" class="dropdown-item">Skills</a>
...
<!-- This code is for  OnBording ends here -->
