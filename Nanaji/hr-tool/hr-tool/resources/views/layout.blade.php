            ...
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                   ...
                   <div class="nav-item dropdown">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>onbording </a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="{{url('ProfilePage')}}" class="dropdown-item">ProfilePage</a>
                            <a href="{{url('Qualification')}}" class="dropdown-item">Qualification</a>
                            <a href="{{url('create')}}" class="dropdown-item">Bankdetails</a>
                            <a href="{{url('create')}}" class="dropdown-item">Work Experience</a>
                            <a href="{{url('create')}}" class="dropdown-item">Skills</a>
                            @if(session('is_manager') =='1')
                                <a href="{{url('admin')}}" class="dropdown-item">Approve leave </a>
                            @endif
                        </div>
