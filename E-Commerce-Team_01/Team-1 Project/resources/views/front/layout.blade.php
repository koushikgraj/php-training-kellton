            ...
            <div class="aa-header-top-area">
              ...
              <div class="aa-header-top-left">
                ...
                <div class="cellphone hidden-xs">
                  <p><span class="fa fa-phone"></span>8008897383</p>
                </div>
                <!-- / cellphone -->
              </div>
              <!-- / header top left -->
            ...
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-logo">
                ...
                <a href="{{url('/')}}">
                  ...
                  <p>ELECTRONICS<strong> Shop </strong> <span>Your Electronics Partner</span></p>
                </a>
                <!-- img based logo -->
              ...
              <div class="col-md-3 col-sm-6">
                <div class="aa-footer-widget">
                  <div class="aa-footer-widget">
                    <h3>Contact Us</h3>
                    <address>
                      <p> KELLTON TECH SOLUTIONS</p>
                      <p><span class="fa fa-phone"></span>8125969814</p>
                      <p><span class="fa fa-envelope"></span>kelltontech@gmail.com</p>
                    </address>
      ...
      <div class="container">
        ...
        <div class="col-md-12">
          <div class="aa-footer-bottom-area">
            <p>Designed by <a href="http://www.markups.io/">Internal Batch Team one</a></p>
